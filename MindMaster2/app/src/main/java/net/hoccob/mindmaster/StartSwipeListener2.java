...
import net.hoccob.mindmaster.activity.StartActivity;


public class StartSwipeListener2 extends GestureDetector.SimpleOnGestureListener {
    ...
    private SinglePlayerActivity activity = null;

    public SinglePlayerActivity getActivity() {
        return activity;
    }

    public void setActivity(SinglePlayerActivity activity) {
